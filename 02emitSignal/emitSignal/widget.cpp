    ...
    : QWidget(parent)
{
    ...
    b1 = new MyQPushButton("OK", this);//按键依附于this窗口
    ...
    //连接信号与曹
    connect(b2, SIGNAL(sendtex(QString)), le, SLOT(setText(QString)));
    connect(b1, SIGNAL(sendtex(QString)), le, SLOT(setText(QString)));
